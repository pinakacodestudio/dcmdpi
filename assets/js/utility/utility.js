...
/*
 * Dockmodal - jQuery dockable modal dialog widget
   ...
   $.fn.adminpanel = function(options) {
      ...
      var methods = {
         init: function(options) {
               ...
               plugin.sortable({
                  ...
                  start: function(e, ui) {
                    ...
                    ui.placeholder.height(ui.helper.outerHeight() - 4);
                     // Body.addClass('ui-drag-active').css('overflow-x', 'hidden'); // newer
                     // ui.placeholder.height(ui.helper.outerHeight() - 5); // newer
                  },
                  beforeStop: function() {
                     // onMove callback
            ...
            // Create Mobile controls after panels have rendered
         ...
         createMobileControls: function(options) {
            ...
            panels.each(function(i, e) {
                ...
                var controlW = Heading.children('.panel-controls').width();
                var titleW = Heading.children('.panel-title').width();
                // var headingW = This.children('.panel-heading').width();
                var mobile = (controlW + titleW); // manually added width, assumes all controls are used
                arr[ID] =  mobile;
                // console.log(titleW);
            });
         ...
         createControls: function(options) {
            ...
            var Buttons = {
                panelLoader: '<a href="#" class="panel-control-loader"></a>',
                panelRemove: '<a href="#" class="panel-control-remove"></a>',
                panelTitle: '<a href="#" class="panel-control-title"></a>',
                panelColor: '<a href="#" class="panel-control-color"></a>',
                panelCollapse: '<a href="#" class="panel-control-collapse"></a>',
                panelFullscreen: '<a href="#" class="panel-control-fullscreen"></a>',
                // panelCallback: '<a href="#" class="panel-control-callback"></a>',
                // panelDock: '<a href="#" class="panel-control-dock" data-toggle="popover" data-content="panelDockContent();"></a>',
                // panelExpose: '<a href="#" class="panel-control-expose"></a>',
            };
            ...
            panels.each(function(i, e) {
               ...
               // Add Activated buttons to panel controls
               panelHeader.children('.panel-controls').html(activeBtns);

               // var Data = This.data();
               // console.log(Data.panelRemove);

               // Check panel for settings specific attr. Use this
               // value to determine if menu item should be displayed
               // var title = Data.panelTitle;
               // var color = Data.panelColor;
               // var collapse = Data.panelCollapse;
               // var fullscreen = Data.panelFullscreen;
               // var remove = Data.panelRemove;
               // var callback = Data.panelCallback;
               // var paneldock = Data.panelDockable;
               // var expose = Data.panelExpose;
               // var loader = Data.panelLoader;
               // var title = This.attr('data-panel-title');

                // These buttons are active by default. They will
                // be removed if a data attribute is present on the panel
               // if (!loader &&  loader === undefined) {
               //    activeBtns += panelLoader;
               //    // $(panelLoader).appendTo(panelMenu);
               // }
               // if (!remove && remove === undefined) {
               //    activeBtns += panelRemove;
               //    // $(panelRemove).appendTo(panelMenu);
               // }
               // if (!title && title === undefined) {
               //     activeBtns += panelTitle;
               //    // $(panelTitle).appendTo(panelMenu);
               // }
               // if (!color && color === undefined) {
               //     activeBtns += panelColor;
               //    // $(panelColor).appendTo(panelMenu);
               // }
               // if (!collapse && collapse === undefined) {
               //     activeBtns += panelCollapse;
               //    // $(panelCollapse).appendTo(panelMenu);
               // }
               // if (!fullscreen && fullscreen === undefined) {
               //     activeBtns += panelFullscreen;
               //    // $(panelFullscreen).appendTo(panelMenu);
               // }

               // These Buttons are deactivated by default
               // if (callback) {
               //    activeBtns += panelCallback;
               //    $(panelCallback).appendTo(panelMenu); // callback attr must be set true, else icon hidden
               // }
               // if (expose) {
               //    $(panelExpose).appendTo(panelMenu); // Upcoming feature, not currently implemented
               // }
               // if (paneldock) {
               //    $(panelDock).appendTo(panelMenu); // Upcoming feature, not currently implemented
               // }
