<?php
	$pageSave = base_url() . "Order/savemsg/"
?>
	...
	<div class="modal-body">
		<div class="row">
			<?php
				...
				editbox(12, "Mobile No.", "mobileno", "Enter Mobile No.", $mobile ,"readonly");
				textareabox(12, "Message", "message", "Enter Message.", $message,"readonly");
			?>
		</div>
