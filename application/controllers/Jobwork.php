...
class Jobwork extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $total_records = $this->Queries->getJobworkCount($searchtxt);
        $params['orderlist'] = $this->Queries->getJobwork($searchtxt, $limit_per_page, $start_index);
       ...
       // Add user data in session
        ...
        $this->load->view('Jobwork/index', $params);
    }
    ...
    public function add($id = 0)
    {
        try {
            ...
            $this->load->view('Jobwork/jobwork', ['id' => $id, 'order' => $order, 'dispatchlist' => $dispatchlist]);
        } catch (Exception $e) {
            echo $e;
        }
    }
    public function save()
    {
        ...
        return redirect('Jobwork/index/' . $page);
